...
form.addEventListener("input", (0, _lodashThrottleDefault.default)(saveMessage, 500));
function saveMessage() {
    ...
    _storage.default.save(LOCALSTORAGE_KEY, feedback);
}
const parsedInput = _storage.default.load(LOCALSTORAGE_KEY);
...
function afterSubmit(event) {
    ...
    form.reset();
    _storage.default.remove(LOCALSTORAGE_KEY);
}
